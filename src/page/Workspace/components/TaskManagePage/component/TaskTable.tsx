...
export const TaskTypeMap = {
  ...
  [TaskType.PERMISSION_APPLY]: formatMessage({
    id: 'odc.TaskManagePage.component.TaskTable.ApplyForConnectionPermissions',
  }),
      ...
      const columns = [
        {
          dataIndex: 'id',
          title: formatMessage({
            id: 'odc.TaskManagePage.component.TaskTable.TaskNo',
          }),
...

        {
          dataIndex: 'type',
          title: formatMessage({
            id: 'odc.TaskManagePage.component.TaskTable.TaskType',
          }),
...

        {
          ...
          title: formatMessage({
            id: 'odc.components.TaskManagePage.CommonPage.Connection',
          }),
...

        {
          ...
          title: formatMessage({
            id: 'odc.TaskManagePage.component.TaskTable.Database',
          }),
...

        {
          dataIndex: 'status',
          title: formatMessage({
            id: 'odc.components.TaskManagePage.TaskStatus',
          }),
