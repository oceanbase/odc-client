...
export interface IImportDrawerProps {
  modalStore?: ModalStore;
  connectionStore?: ConnectionStore;
  schemaStore?: SchemaStore;
}

export interface IImportDrawerState {
  stepIndex: number;
...
@observer
class ImportDrawer extends React.Component<IImportDrawerProps, IImportDrawerState> {
  private _formRef = React.createRef<any>();

  private defaultConfig: IImportDrawerState['formData'] = null;

  constructor(props: IImportDrawerProps) {
    super(props);
