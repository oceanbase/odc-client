...
import { permissionMap, resourceManagementTypeOptions } from '../FormResourceSelector/const';
import resourceActions from '../FormResourceSelector/resourceActions';
import { RoleList } from '../UserPage/component';
...
const getColumns = (roles: IManagerRole[]) => {
  return [
...

    {
      ...
      render: (roleIds) => {
        return <RoleList roleIds={roleIds} />;
      },
    },
...
const UserDetail: React.FC<{
  ...
  const getResourceName = (type: IManagerResourceType, resourceId: number) => {
    const resourceMap = {
      ...
      [IManagerResourceType.role]: [...roles?.values()],
