...
import FormAutoAuthModal from '../FormAutoAuthModal';
...
class AutoAuthPage extends React.PureComponent<IProps, IState> {
  ...
  private getPageColumns = () => {
    return [
      ...
      {
        title: formatMessage({ id: 'odc.components.AutoAuthPage.Status' }), //状态
        width: 115,
        ellipsis: true,
        key: 'enabled',
        dataIndex: 'enabled',
    ...
    return (
      <>
        <CommonTable
          ...
          titleContent={{
            title: formatMessage({
              id: 'odc.components.AutoAuthPage.AutomaticAuthorizationRules',
            }), //自动授权规则
          }}
          filterContent={{
