...
import MultipleSQLCheckNode from '@/component/Task/component/TaskDetailModal/Nodes/MultipleSQLCheckNode';
import RollbackNode from '@/component/Task/component/TaskDetailModal/Nodes/RollbackNode';
import SQLCheckNode from '@/component/Task/component/TaskDetailModal/Nodes/SQLCheckNode';
...
const MiniTaskFlow: React.FC<IProps> = ({ task, result }) => {
