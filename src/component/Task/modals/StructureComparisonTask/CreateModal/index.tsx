        ...
        <Form.Item noStyle>
          ...
          >
            <Radio.Group
              options={[
                {
                  label: comparisonScopeMap[EComparisonScope.PART],
                  value: EComparisonScope.PART,
                },
                {
                  label: comparisonScopeMap[EComparisonScope.ALL],
                  value: EComparisonScope.ALL,
                },
              ]}
            />
          </Form.Item>
            ...
            {({ getFieldValue }) => {
              ...
              return (
                <Form.Item
                  ...
                  rules={rules['parameters-tableNamesToBeCompared']}
                >
                  <TableSelector
