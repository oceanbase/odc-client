...
import { OscMaxDataSizeLimit, OscMaxRowLimit, OscMinRowLimit } from '@/component/Task/const';
      ...
      <Spin spinning={loading}>
        ...
        >
          ...
          >
            <Radio.Group
              options={[
                { label: 'CREATE TABLE', value: SqlType.CREATE },
                {
                  label: 'ALTER TABLE',
                  value: SqlType.ALTER,
                },
          ...
          >
            <Row>
              <Col span={6}>
                ...
                >
                  <Form.Item
                    ...
                    rules={rules.lockTableTimeOutSeconds as Rule[]}
                    initialValue={5}
                    noStyle
                  >
              ...
              <Col span={6}>
                <Form.Item
                  ...
                  initialValue={3}
                  required
                  rules={rules.swapTableNameRetryTimes}
                >
            ...
            <Form.Item
              ...
              rules={rules.originTableCleanStrategy}
            >
              <Radio.Group
                options={[
                  {
                    ...
                    value: ClearStrategy.ORIGIN_TABLE_RENAME_AND_RESERVED,
                  },
                  {
                    label: formatMessage({
                    ...
                    value: ClearStrategy.ORIGIN_TABLE_DROP,
                  },
                ]}
              />
            </Form.Item>
          ...
          >
            ...
            <Form.Item
              ...
              rules={rules.swapTableType}
            >
              <Radio.Group
                options={[
                  {
                    value: SwapTableType.AUTO,
                    label: formatMessage({
