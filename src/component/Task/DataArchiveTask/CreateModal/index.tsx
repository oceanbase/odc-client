  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item
          label={formatMessage({ id: 'odc.DataArchiveTask.CreateModal.Remarks' })} /*备注*/
          name="description"
          rules={[
            {
              max: 200,
              message: formatMessage({
                id: 'odc.DataArchiveTask.CreateModal.TheDescriptionCannotExceedCharacters',
              }), //备注不超过 200 个字符
            },
          ]}
        >
          <Input.TextArea
            ...
            placeholder={formatMessage({
              id: 'odc.DataArchiveTask.CreateModal.EnterAComment',
            })} /*请输入备注*/
          />
        </Form.Item>
      </Form>
