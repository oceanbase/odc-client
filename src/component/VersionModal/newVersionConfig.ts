...
export default [
...

  {
    ...
    describe: formatMessage({
      ...
      defaultMessage: '提供全量的业务操作记录功能，保证用户的操作可追溯，支持记录的查看、筛选',
...

  {
    ...
    describe: formatMessage({
      ...
      defaultMessage: '优化脚本管理，可查看和管理保存的脚本文件，同时支持脚本的批量上传与下载',
...

  {
    ...
    describe: formatMessage({
      ...
      defaultMessage: '表对象右键能力增强，同时支持将表对象拖放至 SQL 窗口快速生成语句',
...

  {
    ...
    describe: formatMessage({
      ...
      defaultMessage: '个人设置支持切换独立 Session，各个 SQL 窗口可并发执行 SQL 语句',
