...
interface IDataMockerDrawerProps extends Pick<DrawerProps, 'visible'> {
...
const DataMockerDrawer: React.FC<IDataMockerDrawerProps> = inject(
  'modalStore',
  'schemaStore',
  'connectionStore',
  'taskStore',
...
export default DataMockerDrawer;
