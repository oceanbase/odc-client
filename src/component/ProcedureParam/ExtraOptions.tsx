    ...
    <>
      <Row gutter={12}>
        {config?.deterministic ? (
          <Col span={8}>
            <Form.Item label="决定性" name={['characteristic', 'deterministic']}>
        ...
        {config?.dataNature ? (
          <Col span={8}>
            <Form.Item label="数据选项" name={['characteristic', 'dataNature']}>
              <Select style={{ width: '100%' }}>
        ...
        {config?.sqlSecurity ? (
          <Col span={8}>
            <Form.Item label="SQL 安全性" name={['characteristic', 'sqlSecurity']}>
              <Select style={{ width: '100%' }}>
