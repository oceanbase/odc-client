          ...
          routes: [
            {
              ...
              routes: [
                ...
                { path: '/project/:id/schedule/create',  component: '@/page/ScheduleCreatePage' },
                ...
                { path: '/schedule', component: '@/page/Schedule' },
                { path: '/schedule/create', component: '@/page/ScheduleCreatePage' },
